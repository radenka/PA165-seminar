    ...
    public BigDecimal convert(Currency sourceCurrency, Currency targetCurrency, BigDecimal sourceAmount) {
        ...
        try {
            ...
            if (exchangeRate == null) {
                log.warn("Exchange rate for {} and {} is unknown.", sourceCurrency, targetCurrency);
            ...
            log.error("Error when fetching exchange rate for {} and {}.", sourceCurrency, targetCurrency);
